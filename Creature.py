...
if os.getenv("USE_LOCAL"):
    ...
    logging.debug("Running on cloud")
...
a = Ability(name="Third Best ability, but good enough")
c = Creature(name="icwdibcidwbc", hp=100, image="11", description="Something",
             attack=8, defense=10, speed=5)
...
for each_filler_creature, each_ability in zip(creatures, abilities):
    ...
    c = Creature(name=creature_name, description=creature_description, hp=hp, attack=attack, defense=defense, speed=speed, lore=creature_lore)
